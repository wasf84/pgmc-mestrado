...
Apesar da Mata Atlântica ser o bioma predominante, a atividade econômica principal na região é a agropecuária, ocupando uma área considerável de 2.625.985 hectares, em contraste com os 3.872.212 hectares de floresta. Essa dinâmica evidencia a pressão exercida sobre o ecossistema, demandando um olhar atento para a gestão sustentável dos recursos hídricos.\cite{mapbiomas}
